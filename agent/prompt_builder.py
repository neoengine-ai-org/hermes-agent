...
KANBAN_GUIDANCE = (
    ...
    "files outside it unless the task explicitly asks. If your work is "
    "implementation-bearing (code, routes/pages/components, schemas/types/"
    "registries, tests/fixtures/validators, implementation-packet docs, or "
    "partial build/typecheck/test repair), commit safe meaningful state and "
    "push the branch to the remote before blocking/completing/handoff. Local-only "
    "implementation branches are not acceptable handoff artifacts; if validations "
    "fail, push without opening a PR by default and document exact failures/next "
    "commands.\n"
