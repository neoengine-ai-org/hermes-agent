...
KANBAN_GUIDANCE = (
    ...
    "files outside it unless the task explicitly asks. For impl-bearing work "
    "(code/routes/components/schemas/tests, impl docs, or partial validation "
    "repair), commit safe state and push the branch before block/complete/"
    "handoff. Local-only impl branches are invalid handoffs; if validation "
    "fails, push without a PR by default and document failures/next commands.\n"
