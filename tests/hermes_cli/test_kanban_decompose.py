...
def test_decompose_with_fanout_creates_children(kanban_home):
    ...
    call_llm_patch = _patch_aux_client(llm_payload)
    for p in patches:
        p.start()
    try:
        with call_llm_patch as call_llm_mock, _patch_extra_body():
    ...
    assert call_llm_mock.call_args.kwargs["max_tokens"] == 3072
