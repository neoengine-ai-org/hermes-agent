...
class TestModuleConstants:
    ...
    def test_default_turn_budget(self):
        assert DEFAULT_TURN_BUDGET_CHARS == 100_000
...
class TestResolveThreshold:
    ...
    @patch("tools.registry.registry")
    def test_compact_default_caps_100k_tool(self, mock_registry):
        """The compact default caps legacy 100K registry tools at 50K."""
        mock_registry.get_max_result_size.return_value = 100_000
        cfg = BudgetConfig()
