...
class AIAgent:
    ...
    def _run_codex_raw_sse_fallback(self, api_kwargs: dict, client: Any = None):
        """Forwarder — see ``agent.codex_runtime.run_codex_raw_sse_fallback``."""
        from agent.codex_runtime import run_codex_raw_sse_fallback
        return run_codex_raw_sse_fallback(self, api_kwargs, client)
